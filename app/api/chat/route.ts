...
export async function POST(req: Request) {
  try {
    ...
    if (process.env.OPENAI === "ENABLED") {
      const response = await openai.responses.create({
        ...
        tools: [
          ...
          },
          {
            ...
            server_url:
              "https://98e8422c-f118-4831-be30-dca52a069eb5.search.ai.cloudflare.com/mcp",
            server_description:
              "search and find products, indexed on cloudflare AI semantic search",
          ...
          },
          {
            ...
            allowed_tools: ["Artists N Models"],
            require_approval: "always",
          },
          {
            type: "mcp",
      ...
      return Response.json({
        reply: response.output_text ?? "No response from server.",
      });
    }
